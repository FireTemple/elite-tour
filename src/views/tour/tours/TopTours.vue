<template>
  <div class="container margin_60">
    ...
    <div class="main_title">
      <h2>Zoom Ride <span>Top</span> Tours</h2>
    ...
    <!-- End row -->
    <p class="text-center add_bottom_30 " @click="viewAll">
      <a href="javascript:void(0);" class="btn_1 medium"><i class="icon-eye-7" ></i>View all tours (144)</a>
    </p>
  </div>
</template>
